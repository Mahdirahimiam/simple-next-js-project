...
//     return (
//       <Card key={index} title={item.brandName} description={item.name} id={item.id} image={item.imageUrl}/>
//       )
//   })
//   return (
//     <div className='Home'style={{minHeight:'80vh'}}>{data ? items:<Loading/>}</div>
//   )
// }
